...
import { fdb, usersCollection, authAccountsCollection } from '@/lib/googlecloud/fdb'; // Adjust based on your Firestore setup
...
export async function DELETE(req: NextRequest) {
  try {
    ...
    const userDocRef = usersCollection(fdb).doc(userId);
    ...
    const accountsQuery = authAccountsCollection(fdb).where('userId', '==', userId);
